...
def load_and_process_image(image_path=None):
    """
    Load an image and save this script with a random name.
    If no image is provided, creates a simple test image.
    This version doesn't display the image to avoid GUI issues.
    """
    ...
    # Print image info instead of displaying
