...
def save_factorial_function():
    ...
    """
    # Generate a random filename that starts with a letter to be a valid Python module
    random_name = ''.join(random.choices(string.ascii_lowercase, k=1)) + ''.join(random.choices(string.ascii_lowercase + string.digits, k=9))
