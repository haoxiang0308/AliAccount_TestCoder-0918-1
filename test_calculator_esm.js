// test_calculator_esm.js - Mocha tests for calculator module (ESM version)

const { add, subtract, multiply, divide } = require('./calculator');

// Using dynamic import for Chai since it's an ES module
let expect;

describe('Calculator Functions', function() {
  // Load Chai dynamically before running tests
