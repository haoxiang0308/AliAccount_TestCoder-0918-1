...
class ProfileViewController: UIViewController {
    ...
    var userBio: String = "This is a sample bio for the user profile. It can contain multiple lines of text describing the user." {
        didSet {
    ...
    private func setupUI() {
        ...
        // For demo purposes, using system image
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            bioTextView.topAnchor.constraint(equalTo: emailLabel.bottomAnchor, constant: 30),
