...
namespace WebApi.Controllers
{
    ...
    public class XlcesucgynController : ControllerBase
    {
        private readonly ILogger<XlcesucgynController> _logger;

        public XlcesucgynController(ILogger<XlcesucgynController> logger)
        {
            _logger = logger;
        }
